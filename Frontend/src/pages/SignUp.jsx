    ...
    <div className='bg-slate-900 flex flex-col sm:flex-row text-white h-screen'>
        ...
        <div  className='sm:w-[50%]  flex flex-col item-center sm:mt-20 '>
            ...
            <form onSubmit={handleSubmit} className='mx-auto  flex flex-col items-center justify-center mt-10'>
                <input onChange={handleOnChange} required className='outline-none m-2 py-4 px-10 rounded-lg bg-transparent border-2 border-orange-900' id="username" placeholder='Enter your username' type="text" />
                <input onChange={handleOnChange} required className='outline-none m-2 py-4 px-10 rounded-lg bg-transparent border-2 border-orange-900' id='email' placeholder='Enter your email' type="email" />
                <input onChange={handleOnChange} required className='outline-none m-2 py-4 px-10 rounded-lg bg-transparent border-2 border-orange-900' id='password' placeholder='Enter your password' type="password" />
